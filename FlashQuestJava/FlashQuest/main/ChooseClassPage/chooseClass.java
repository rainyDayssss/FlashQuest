...
public class chooseClass {
    ...
    public chooseClass(Stage stage, FlashQuestController flashQuestController) {
        this.stage = stage;
    ...
    public void show() {
        ...
        chooseWarrior.setOnAction(e -> controller.clickWarriorBtn());
        chooseTank.setOnAction(e -> controller.clickTankBtn());
        chooseMage.setOnAction(e -> controller.clickMageBtn());
